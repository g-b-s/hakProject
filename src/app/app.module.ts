...
import { messagingService } from 'src/Service/angular-messaging.service';
import { Messaging, MessagingModule } from '@angular/fire/messaging';
...
@NgModule({
  ...
  providers: [signupService,sharedService, ScreenTrackingService,UserTrackingService,messagingService],
